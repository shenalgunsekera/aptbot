-- ═══════════════════════════════════════════════════════════════════════════
-- 0109 — /addtowithdraw hint on ONE line (userMessage keeps only the first line)
-- ═══════════════════════════════════════════════════════════════════════════
-- 0107 put the hint on a second line with \n, but the bots' userMessage() does
-- .split('\n')[0] (to drop Postgres CONTEXT lines), so the hint was chopped off
-- and players only ever saw "…finish or cancel it first." Same message, now one
-- line so the whole thing shows. Only that raise string changes vs 0107.
