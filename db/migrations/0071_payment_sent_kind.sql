-- ═══════════════════════════════════════════════════════════════════════════
-- 0071 — Announce OUTGOING payments ('sent') in the payments feed
-- ═══════════════════════════════════════════════════════════════════════════
--
-- PayPal also emails a receipt for money WE send ("You sent $X to NAME"). We now
-- parse those as kind='sent' and want them shown in the payments channel as
-- "You sent …", without ever matching them to a deposit. Same announce-only path
-- as 'request'/'cancel'. Only change vs 0067: 'sent' joins that branch.
